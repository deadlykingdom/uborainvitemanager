...
collector.on('collect', (reaction, user) => {
    ...
    const kobscode = new Discord.MessageEmbed()
      .setColor("BLUE")
 .addField("**Davet Komutları**", `\n**ui!**__rütbe-ekle @rol davet__ = **__Rütbe Ekler__** \n**ui!**__rütbeler__ = **__Rütbeleri Gösterir 1 Den 10'a Kadar__** \n**ui!**__rütbe-sıfırla__ = **__Rütbeyi Sıfırlar.__** \n**ui!**__davetleri-sıfırla__ = **__Davetleri Sıfırlar.__** \n**ui!**__top__ = **__Lider Tablosunu Gösterir.__** \n**ui!**__davetlerim__ = **__Davetlerinizi Gösterir.__** \n**ui!**__bonus-ekle__ = **__Bonus Ekler.__** \n**ui!**__davet-kanal #kanal__ = **__Davet Kanalını Ayarlar.__** \n**!**__davet-kanal-sıfırla__ = **__Davet Kanalını Sıfırlar.__**`)
